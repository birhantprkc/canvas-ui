"use client";
// Generated by scripts/build-live-wrappers.mts from src/lib/Bend/Bend.tsx. Do not edit.
...
import * as WebGL from "@/lib/Bend/BendVanilla";
import * as WebGPU from "@/lib/Bend/BendWebGPU";
import { useLiveRenderer } from "@/components/docs/live-renderer";

type BendInstance = WebGL.BendInstance;
type BendOptions = WebGL.BendOptions;
...
export function Bend({ children, className, style, ...options }: BendProps) {
  ...
  const { createBend, supportsHtmlInCanvas } = engine;
  ...
  }, [initialOptions, native, renderer, createBend]);
