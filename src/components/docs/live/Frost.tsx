"use client";
// Generated by scripts/build-live-wrappers.mts from src/lib/Frost/Frost.tsx. Do not edit.
...
import * as WebGL from "@/lib/Frost/FrostVanilla";
import * as WebGPU from "@/lib/Frost/FrostWebGPU";
import { useLiveRenderer } from "@/components/docs/live-renderer";

type FrostInstance = WebGL.FrostInstance;
type FrostOptions = WebGL.FrostOptions;
...
export function Frost({ children, className, style, ...options }: FrostProps) {
  ...
  const { createFrost, supportsHtmlInCanvas } = engine;
  ...
  }, [initialOptions, native, renderer, createFrost]);
