"use client";
// Generated by scripts/build-live-wrappers.mts from src/lib/Grid/Grid.tsx. Do not edit.
...
import * as WebGL from "@/lib/Grid/GridVanilla";
import * as WebGPU from "@/lib/Grid/GridWebGPU";
import { useLiveRenderer } from "@/components/docs/live-renderer";

type GridInstance = WebGL.GridInstance;
type GridOptions = WebGL.GridOptions;
...
export function Grid({ children, className, style, ...options }: GridProps) {
  ...
  const { createGrid, supportsHtmlInCanvas } = engine;
  ...
  }, [initialOptions, native, renderer, createGrid]);
