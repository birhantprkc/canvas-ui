"use client";
// Generated by scripts/build-live-wrappers.mts from src/lib/VHS/VHS.tsx. Do not edit.
...
import * as WebGL from "@/lib/VHS/VHSVanilla";
import * as WebGPU from "@/lib/VHS/VHSWebGPU";
import { useLiveRenderer } from "@/components/docs/live-renderer";

type VHSInstance = WebGL.VHSInstance;
type VHSOptions = WebGL.VHSOptions;
...
export function VHS({ children, className, style, ...options }: VHSProps) {
  ...
  const { createVHS, supportsHtmlInCanvas } = engine;
  ...
  }, [initialOptions, native, renderer, createVHS]);
